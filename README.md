...
또한 판매 기한이 얼마 남지 않았거나 재고 소진이 필요한 상품을 위한 **재고떨이 공동구매**와, 폐업 재고 기부 또는 가게 홍보 목적으로 상품을 나누는 **완전무료! 상품**을 제공합니다.
...
재고 소진이 필요한 상품을 50% 할인가로 제공하고, 총 재고의 70% 이상이 참여하면 70% 할인을 적용하는 재고떨이 특가 영역입니다.

### 완전무료! 상품

상품 가격과 사이트 수수료 없이 물품을 나눕니다. 택배 수령은 택배비만 결제하고, 매장 직접 픽업은 2,000원 보증금을 결제한 뒤 교환 코드 또는 QR로 수령하면 보증금을 전액 반환받습니다.
...
| `/mypage/profile` | 내 정보 관리 | 닉네임, 연락처, 기본 배송지 등록 및 수정 |
