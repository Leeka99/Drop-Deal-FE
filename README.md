...
현재 진행 중인 공동구매 상품의 가격과 참여 현황을 비교할 수 있습니다. 상품 카드에서 현재 할인율, 현재가, 참여 인원, 다음 가격 하락까지 필요한 인원, 남은 재고를 확인할 수 있습니다.

### 재고가 많을수록 커지는 할인

![DropDeal 재고떨이 특가 상품 목록](readmefiles/intro3.png)

재고 소진이 필요한 상품을 더 큰 할인율로 제공하는 재고떨이 특가 영역입니다. 재고떨이 여부, 실시간 진행 상태, 50% 쿠폰 이벤트 대상 상품을 배지로 구분합니다.
...
| `/admin/commission-policies` | 수수료 정책 관리 | 판매자·상품 유형별 중개수수료 정책 설정 |
...
| 상품 유형 | 예정 수수료율 |
| --- | ---: |
| 일반 공동구매 | 최종 판매금액의 7~10% |
| 재고털이 상품 | 최종 판매금액의 10~15% |
| 신규 판매자 프로모션 | 첫 1~3개월 동안 3~5% |
