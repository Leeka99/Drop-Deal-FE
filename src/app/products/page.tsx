...
export default async function ProductsPage({ searchParams }: { searchParams: Promise<{ type?: string }> }) {
  ...
  return (
    <div className="shell">
      <div className="page-hero"><span className="eyebrow">Explore deals</span><h1 className="page-title">함께 내릴 상품을 찾아보세요</h1><p className="page-lead">참여자가 많아질수록 가격은 더 낮아집니다.</p></div>
